...
class RDN(object):
    ...
    def model(self):
        ...
        tensorB = build_model1(tensorD1, 64, 10, 1, 1, if_a=False, if_b=True, if_c=True)
       ...
       # tensorD_2 = cbam_block(tensorD_2, 'conv_feature1', 8)
        # # ======================== cbam_block ======================  #======================== cbam_block =========================
    ...
    def train(self, config):
       ...
       # print(data_dir)
        ...
        data_dir_v ="/root/workspace/shiyonglian/RDN-TensorFlow-master/Eval/train.h5" # "/media/li-547/Liwen/A-final/clique_attention_2_5/Validate/div_2.h5"
    ...
    def load(self, checkpoint_dir):
        print("\nReading Checkpoints.....\n")
        model_dir = "%s_%s_%s_%s_x%s" % ("clique_2_5_attention", self.D, self.C, self.G, self.scale)
