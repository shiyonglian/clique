...
from model_espcn_cbam_clique3_4 import RDN
...
flags.DEFINE_string("train_set", "/root/workspace/shiyonglian/RDN-TensorFlow-master/Train/DIV2K_train_HR", "name of the train set")
flags.DEFINE_boolean("is_test",True, "if the test")
